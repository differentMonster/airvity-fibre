			...
			<div className="container">
				<div className="row">
					<div className="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 ">
						<div className="ps-product">
							<div className="ps-product__thumbnail">
								<img className="ps-product__image" src="/img/product/default/4.jpg" alt="" />
								<img className="ps-product__image-alt" src="/img/product/default/4.jpg" alt="" />
					...
					<div className="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 ">
						<div className="ps-product">
							<div className="ps-product__thumbnail">
								<img className="ps-product__image" src="/img/product/default/3.jpg" alt="" />
								<img className="ps-product__image-alt" src="/img/product/default/3.jpg" alt="" />
								<a className="ps-product__overlay" href="product-default.html"></a>
								<div className="ps-product__actions">
									<a href="shopping-cart.html"> Add to cart</a>
									<ul>
