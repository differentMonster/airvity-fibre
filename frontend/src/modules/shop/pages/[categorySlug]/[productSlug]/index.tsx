...
// Components
const ShopProductHeader = dynamic(
  () => import('../../../components/ShopProductHeader')
);
const ShopProductRelated = dynamic(
  () => import('../../../components/ShopProductRelated')
);
const ShopProductBreadcrumbs = dynamic(
  () => import('../../../components/ShopProductBreadcrumbs')
);
