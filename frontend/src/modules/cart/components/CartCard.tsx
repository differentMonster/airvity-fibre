					...
					<tr>
						...
						<td>
							<div className="form-group--number">
								<button id="form-group-number--increase" className="up"></button>
								<button id="form-group-number--decrease" className="down"></button>
								<input id="form-group-number--quantity" className="form-control" type="text" />
							</div>
						</td>
						<td>
							<p>
